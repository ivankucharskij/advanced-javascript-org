...
import { appName, ORIGIN } from "@/lib/shared";
      ...
      <HomeLayout {...baseOptions()} links={homeLinks}>
        <div className="grid items-start grid-cols-1 gap-4 md:gap-10 px-4 md:px-6 mx-auto w-full max-w-350 lg:grid-cols-2 mt-2 md:mt-4">
          ...
          <p className="text-2xl tracking-tight leading-snug font-light col-span-full md:text-3xl xl:text-4xl">
            ...
            with focused code snippets covering arrays, promises, the event
            loop, data structures, utility functions, and common interview edge
            cases. Read each snippet, predict the output, then check your
            reasoning against a concise explanation. The questions are based on
            the JavaScript topics that come up most often in interviews.
          </p>
          <SnippetCodeRunner
          ...
          <section className="col-span-full grid gap-6 md:grid-cols-3">
            <div>
              ...
              <p className="mt-3 text-base leading-7 text-fd-muted-foreground">
                ...
                to understand: array methods, promise chains, microtasks,
                sorting callbacks, maps and sets, object references, recursion,
                and small utility functions. The examples are short enough to
                read carefully, but they still cover the behavior that every
            ...
            <div>
              ...
              <p className="mt-3 text-base leading-7 text-fd-muted-foreground">
                ...
                so it&#39;s always better to be prepared if you&#39;re looking
                for a job.
              </p>
            </div>
            <div>
              ...
              <p className="mt-3 text-base leading-7 text-fd-muted-foreground">
                ...
                callback runs, whether a value was copied or shared, how
                coercion changes a comparison, or how Promise.all works.
                Practice here, then use{" "}
                <a
          ...
          <ul className="rounded-2xl text-sm p-6 bg-origin-border shadow-lg border bg-fd-card flex flex-col gap-6 col-span-full mb-8">
            ...
            <li className="flex flex-row flex-wrap gap-2 mt-auto">
              ...
              <a
                href="https://github.com/ivankucharskij/advanced-javascript-org"
