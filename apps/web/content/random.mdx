...
The utilities are grouped by the problem they solve: class-name composition, cloning, joining related data, retrying async work,
reducer-style updates, shuffling, and dependency ordering. Treat them as patterns you can adapt, not as functions to copy blindly.
