...
description: How Advanced JavaScript collects, uses, and protects account and challenge practice data.
---
...
Advanced JavaScript is a JavaScript learning and challenge practice app. This policy explains what information the app collects, how it is used, and what choices you have.

## Information We Collect

When you use the app without signing in, we may create a temporary guest session so your challenge progress can continue during the current session.
...
We also store challenge practice progress, including which challenges you answered, review status, answer counts, and correct answer counts.
...
- keep your challenge progress across sessions
...
Account data and challenge progress are kept while your account is active. Guest session data is temporary and may be discarded after sign-in or when no longer needed.
