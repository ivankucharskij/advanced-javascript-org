...
description: Terms for using Advanced JavaScript and its challenge practice features.
---
...
These terms apply to your use of Advanced JavaScript, a JavaScript learning and challenge practice app.

## Use of the App

You may use the app to study JavaScript topics, read examples, and practice challenges. You agree not to misuse the app, interfere with its operation, or attempt to access data that does not belong to you.
